...
namespace Drupal\commerce_paycom\Controller;
 ...
 */
class CommercePaycomResponse implements ContainerInjectionInterface {
  ...
  /**
   * Constructs a new CommercePaycomResponse object.
   *
  ...
  /**
   * Callback method which accepts GET.
   *
